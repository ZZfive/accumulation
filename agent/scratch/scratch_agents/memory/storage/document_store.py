...
class DocumentStore(ABC):
    ...
    @abstractmethod
    def search_memories(self, user_id: str = None, memory_type: str = None, start_time: int = None,
                        end_time: int = None, importance_threshold: float = None, limit: int = 10) -> List[Dict[str, Any]]:
        r"""搜索记忆"""
        pass

    @abstractmethod
    def update_memory(self, memory_id: str, content: str = None, importance: float = None, properties: Dict[str, Any] = None) -> bool:
        r"""更新记忆"""
        pass
