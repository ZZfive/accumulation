...
class Tool(ABC):
    ...
    def __init__(self, name: str = None, description: str = None, expandable: bool = False) -> None:
        r"""初始化工具
    ...
    def get_expanded_tools(self) -> Optional[List["Tool"]]:
        ...
        默认实现：自动从标记了 @tool_action 装饰器的方法中生成子工具
        子类可以重写此方法提供自定义的展开逻辑
        ...
        for name, method in inspect.getmembers(self, predicate=inspect.ismethod):
            if hasattr(method, 'is_tool_action'):
    ...
    def to_openai_schema(self) -> Dict[str, Any]:
        r"""转换为OpenAI function calling schema格式
